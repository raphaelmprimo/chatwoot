...
ActiveRecord::Schema[7.0].define(version: 2024_08_10_173803) do
  ...
  create_table "conversations", id: :serial, force: :cascade do |t|
    ...
    t.index ["label_id"], name: "index_conversations_on_label_id"
  ...
  create_table "label_attributes", force: :cascade do |t|
    t.bigint "custom_attribute_definition_id", null: false
    t.bigint "label_id", null: false
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["custom_attribute_definition_id"], name: "index_label_attributes_on_custom_attribute_definition_id"
    t.index ["label_id"], name: "index_label_attributes_on_label_id"
  end
  ...
  create_table "labels", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: nil, null: false
    t.datetime "updated_at", precision: nil, null: false
    t.boolean "can_add_schedule", default: false, null: false
    t.boolean "final_step", default: false, null: false
    t.integer "position"
  ...
  add_foreign_key "label_attributes", "custom_attribute_definitions"
  add_foreign_key "label_attributes", "labels"
