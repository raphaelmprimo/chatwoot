<template>
  <transition name="menu-slide">
    <div
      ...
      class="right-3 rtl:right-auto rtl:right-3 top-16 w-64 absolute z-30 rounded-md shadow-xl bg-white dark:bg-slate-800 py-2 px-2 border border-slate-25 dark:border-slate-700"
